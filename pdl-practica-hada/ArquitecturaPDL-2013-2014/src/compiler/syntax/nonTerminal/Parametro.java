...
public class Parametro extends NonTerminal {
    ...
    public Parametro (Var variable, TypeIF tipo){
    	Var v = variable;
    	this.nombre=v.getName();
    	this.valor=v.getValue();
    	this.columna=v.getColumn();
    	this.linea=v.getLine();
    	this.tipo=tipo;
    }
    ...
    public String toString() {
        return "PARAM-->Nom:"+this.getNombre() + "; Valor:" + this.getValor() + "; Lin:" + this.getLinea() + "; Col:" + this.getColumna();
    }
